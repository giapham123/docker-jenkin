...
public class PasswordGenerator {
    ...
    public String generate() {
        List<Integer> givenList = Arrays.asList(8, 9, 10);
        Random rand = new Random();
        int lengthMaster = givenList.get(rand.nextInt(givenList.size()));
        // Argument Validation.
        if (lengthMaster <= 0) {
            return "";
        }
        ...
        // Variables.
        StringBuilder password = new StringBuilder(lengthMaster);
