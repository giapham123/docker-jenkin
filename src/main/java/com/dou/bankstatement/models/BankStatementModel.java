...
public class BankStatementModel {
    ...
    private String statmentDtInFileName;

    public String getStatmentDtInFileName() {
        return statmentDtInFileName;
    }

    public void setStatmentDtInFileName(String statmentDtInFileName) {
        this.statmentDtInFileName = statmentDtInFileName;
    }
