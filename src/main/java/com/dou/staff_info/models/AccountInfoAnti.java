package com.dou.staff_info.models;

public class AccountInfoAnti {
    private String id;
    ...
    public String getBrandchId() {
        return brandchId;
    }

    public void setBrandchId(String brandchId) {
        this.brandchId = brandchId;
    }
