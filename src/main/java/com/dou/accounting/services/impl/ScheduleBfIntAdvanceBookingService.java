...
import com.dou.accounting.mappers.ScheduleBfIntAdvanceBookingMapper;
...
@Service
public class ScheduleBfIntAdvanceBookingService implements ScheduleBfIntAdvanceBookingInterface {

    @Autowired
    ScheduleBfIntAdvanceBookingMapper scheduleBfIntAdvanceBookingMapper;
    ...
    public ResponseObject getReduceInterest(ScheduleBfIntAdvanceBookingModel model) {
        ResponseObject rs = new ResponseObject();
        Map result = new HashMap();
        List<ScheduleBfIntAdvanceBookingModel> resultReduceInterest = scheduleBfIntAdvanceBookingMapper.getReduceInterest(model);
        int totalPage = scheduleBfIntAdvanceBookingMapper.countAllDataRepayment(model);
    ...
    @Override
    @TargetDataSource(CommonStrings.DATA_SOURCE_ORCALE)
    public ResponseObject getRepayment(ScheduleBfIntAdvanceBookingModel model) {
        ResponseObject rs = new ResponseObject();
        List<ScheduleBfIntAdvanceBookingModel> result = scheduleBfIntAdvanceBookingMapper.getRepayment(model);
        rs.setData(result);
        rs.setSuccess(true);
        rs.setMessage(null);
        return rs;
    ...
    @Override
    @TargetDataSource(CommonStrings.DATA_SOURCE_ORCALE)
    public byte[] exportRepayment(ScheduleBfIntAdvanceBookingModel model) {
        try {
            List<ScheduleBfIntAdvanceBookingModel> result =  scheduleBfIntAdvanceBookingMapper.getAllRepayment(model);
