...
public class ViewFinnoneEntriesModel {
    ...
    private String isUseDebit;
    private String isUseCredit;


    public String getIsUseDebit() {
        return isUseDebit;
    }

    public void setIsUseDebit(String isUseDebit) {
        this.isUseDebit = isUseDebit;
    }
