...
public class TerminationReportAppModel {
    String product;
    String scheme;
    String agreementNo;
    String agreementId;
    ...
    String fromDate;
    String toDate;
    String advancedInter;
    String deductAmount;
    String netReceiAfterDeduct;
    String waiveOffAmount;

    public String getAdvancedInter() {
        if(advancedInter == null){
            return "0";
        }
        return advancedInter;
    }

    public void setAdvancedInter(String advancedInter) {
        this.advancedInter = advancedInter;
    }
    ...
    public String getNetReceiAfterDeduct() {
        if(netReceiAfterDeduct == null){
            return "0";
        }
        return netReceiAfterDeduct;
    }

    public void setNetReceiAfterDeduct(String netReceiAfterDeduct) {
        this.netReceiAfterDeduct = netReceiAfterDeduct;
    }

    public String getWaiveOffAmount() {
        if(waiveOffAmount == null){
            return "0";
        }
