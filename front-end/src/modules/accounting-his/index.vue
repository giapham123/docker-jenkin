  ...
  <div>
    ...
    <v-card class="home-app-wrapper">
      <v-card-title style="color: #02786b" class="display-1">
        <span>Termination simulation report his</span>
      </v-card-title>
    </v-card>
    <v-card>
      <v-container fluid grid-list-md>
        <v-layout ref="form">
          ...
          <v-flex xs2 style="margin-left:60px">
            <date-picker
              v-model="closureDate"
              label="Closure Date"
              icon="event"
        ...
        <v-layout wrap>
          <!-- <v-layout align-center>
              <v-checkbox v-model="cbLastDuedate" hide-details class="shrink mr-2" style="margin-top:-10px"
            ></v-checkbox>
            <date-picker
          ...
          <v-layout align-center>
            ...
            <v-list-tile-content>
              <v-list-tile-title
              >-120,000 <= receipt-net <= 120,000</v-list-tile-title
              >
            </v-list-tile-content>
          </v-layout>
        </v-layout>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Closure Date', value: 'Closure Date', sortable: false },
  ...
  methods: {
    ...mapActions('accountinghis', ['getDataAccountingHis', 'exportExcelFile']),
    ...mapActions('global', [
      'showErrorMsg',
      'showSuccessMsg',
      'showWarningMsg'
